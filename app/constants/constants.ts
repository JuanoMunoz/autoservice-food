import { LayoutDashboard, UserPlus, Flame, Package, GlassWater, Utensils, Settings, TrendingUp, Table2, Bike } from "lucide-react";
...
export const navItems: NavItem[] = [
    ...
    { href: "/dashboard/domiciliarios", icon: Bike, label: "Domiciliarios", roles: ["SUPER_ADMIN", "ADMIN"] },
    ...
    { href: "/dashboard/mesas", icon: Table2, label: "Mesas", roles: ["SUPER_ADMIN", "ADMIN"] },
